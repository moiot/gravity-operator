...
import (
	...
	pipelinev1alpha1 "github.com/moiot/gravity-operator/pkg/apis/pipeline/v1alpha1"
	versioned "github.com/moiot/gravity-operator/pkg/client/pipeline/clientset/versioned"
	internalinterfaces "github.com/moiot/gravity-operator/pkg/client/pipeline/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/moiot/gravity-operator/pkg/client/pipeline/listers/pipeline/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GravityV1alpha1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GravityV1alpha1().Pipelines(namespace).Watch(options)
			},
		},
