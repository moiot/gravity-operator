...
type FakePipelines struct {
	Fake *FakeGravityV1alpha1
	ns   string
}

var pipelinesResource = schema.GroupVersionResource{Group: "gravity.mobike.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "gravity.mobike.io", Version: "v1alpha1", Kind: "Pipeline"}
