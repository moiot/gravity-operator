...
import (
	...
	scheme "github.com/moiot/gravity-operator/pkg/client/pipeline/clientset/versioned/scheme"
...
func newPipelines(c *GravityV1alpha1Client, namespace string) *pipelines {
	return &pipelines{
		client: c.RESTClient(),
		ns:     namespace,
	}
