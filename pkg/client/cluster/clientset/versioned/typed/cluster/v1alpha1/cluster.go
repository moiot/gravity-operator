...
import (
	...
	scheme "github.com/moiot/gravity-operator/pkg/client/cluster/clientset/versioned/scheme"
...
func newClusters(c *GravityV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
