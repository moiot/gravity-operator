...
import (
	...
	clusterclient "github.com/moiot/gravity-operator/pkg/client/cluster/clientset/versioned/typed/cluster/v1alpha1"
)
...
func (r *Repository) getCluster() *clusterapi.Cluster {
